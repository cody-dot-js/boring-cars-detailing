...
export const fieldClassName = (invalid?: boolean) => cx(
  ...
  invalid && "border-red-300 text-red-300 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500"
);
